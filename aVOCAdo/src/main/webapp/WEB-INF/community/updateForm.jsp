	...
	<form name="form" method="POST" action="<c:url value='/community/update' />">
		<input type="hidden" name="commId" value="${community.id}"/>	  
	  	<div class="form-group row">   
	        <label class="col-lg-2 col-form-label">스터디 ID</label>
	        <div class="col-lg-10">
	        	<p class="form-control-static">${community.id}</p> 
	        </div>
	    </div>       
	    <div class="form-group row">   
	        <label for="name" class="col-lg-2 col-form-label">스터디명</label>
	        <div class="col-lg-10">
	            <input type="text" name="name" class="form-control" value="${community.name}"> 
	        </div>
	    </div>       
	    <div class="form-group row">   
	        <label for="desc" class="col-lg-2 col-form-label">소개</label>
	        <div class="col-lg-10">
		...
		<div class="form-group">        
			...
			<a href="<c:url value='/community/list' />" class="btn btn-link">스터디 목록</a>     
		</div>	 
	</form>
</div>
</body>
